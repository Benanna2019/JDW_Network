...
module.exports = [
  ...
  //       html: `
  //       <picture
  //       ><source type="image/png" media="(min-width: 1200px)" srcset=${props.src} />
  //       <source type="image/png" media="(min-width: 992px)" srcset=${props.src} />
  //       <source type="image/png" media="(min-width: 768px)" srcset=${props.src} />
  //       <source
  //         type="image/png"
  ...
  //       <source media="(min-width: 1200px)" srcset=${props.src} />
  //       <source media="(min-width: 992px)" srcset=${props.src} />
  //       <source media="(min-width: 768px)" srcset=${props.src} />
  //       <source media="(min-width: 576px)" srcset=${props.src} />
  //       <source media="(min-width: 400px)" srcset=${props.src} />
  //       <source media="(min-width: 350px)" srcset=${props.src} />
